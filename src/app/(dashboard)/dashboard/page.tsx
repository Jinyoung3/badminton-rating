    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          ...
          <h3 className="font-semibold text-lg mb-1">Find Events</h3>
          <p className="text-sm text-gray-600">Join tournaments and competitions</p>
        </Link>
        ...
        >
          <div className="text-4xl mb-3 group-hover:scale-110 transition-transform">➕</div>
          <h3 className="font-semibold text-lg mb-1">Create Event</h3>
          <p className="text-sm text-gray-600">Organize your own tournament</p>
        </Link>
